...
const Pizzas = [
  { id: 6, name: 'Fresa', price: 2, image: require('../assets/Pizza/fresa.png') },
  { id: 7, name: 'Coca-cola', price: 1.5, image: require('../assets/Pizza/cococola.png') },
  { id: 8, name: 'Chinoto', price: 1.5, image: require('../assets/Pizza/chinoto.png') },
];

const Bebida_ejemplo = ({ navigation, cart, setCart }) => {
