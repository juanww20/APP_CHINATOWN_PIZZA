...
const Pizzas = [
  { id: 11, name: 'Papa frita', price: 2, image: require('../assets/Pizza/papafritas.jpg') },
];

const Adicional_ejemplo = ({ navigation, cart, setCart }) => {
...
export default Adicional_ejemplo
