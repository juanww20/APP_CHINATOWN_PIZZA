...
const Pizzas = [
  { id: 1, name: 'Pizza Pepperoni Especial', price: 11, image: require('../assets/Pizza/pizzaPepperoni.png') },
  { id: 2, name: 'Pizza Jamón con Tocino', price: 14, image: require('../assets/Pizza/pizzaTocino.png') },
  { id: 3, name: 'Pizza Champiñon', price: 14, image: require('../assets/Pizza/pizzaCham.png') },
  { id: 4, name: 'Pizza Salami con Champiñon', price: 14, image: require('../assets/Pizza/pizzaCham2.png') },
  { id: 5, name: 'Pizza Mexicana', price: 14, image: require('../assets/Pizza/pizzaMexicana.jpg') },
];

const Pizza_ejemplo = ({ navigation, cart, setCart }) => {
